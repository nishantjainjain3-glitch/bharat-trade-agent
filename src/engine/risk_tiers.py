...
def evaluate_survival_tier(
    ...
    elif drawdown_pct >= 5.0 or nifty_day_change_pct <= -2.0:
    ...
    # Defensive: Drawdown between 2.0% and 5.0%, or benchmark index down -0.8% to -2.0%
    elif drawdown_pct >= 2.0 or nifty_day_change_pct <= -0.8:
